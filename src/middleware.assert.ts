...
import { FuncType, Handler, MethodKeys, Methods, Middleware, MiddlewareMethods } from './middleware'
...
ta.assert<ta.Equal<Methods<TSchema<number>>, { a: () => number; b: (_: number) => string }>>()
...
ta.assert<ta.Extends<MiddlewareMethods, MethodKeys<TsCollection<TSchema<string>>>>>()
