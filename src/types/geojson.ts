...
export type TsGeoJSONLine = [TsLegacyCoordinates, TsLegacyCoordinates, ...TsLegacyCoordinates[]]

export type TsGeoJSONRing = [TsLegacyCoordinates, TsLegacyCoordinates, TsLegacyCoordinates, TsLegacyCoordinates, ...TsLegacyCoordinates[]]
