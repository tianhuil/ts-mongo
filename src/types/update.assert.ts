...
ta.assert<ta.Equal<'d.$' | 'd.$[]', SelectFlattenUpdatePaths<Example, boolean>>>()
ta.assert<ta.Not<ta.Extends<'d.x', SelectFlattenUpdatePaths<Example, boolean>>>>()
ta.assert<ta.Not<ta.Equal<`d`, SelectFlattenUpdatePaths<Example, boolean>>>>()
ta.assert<ta.Not<ta.Equal<`d`, SelectFlattenUpdatePaths<Example, boolean>>>>()
ta.assert<
  ta.Equal<'_id' | 'e.f' | 'e.$.f' | 'e.$[].f', SelectFlattenUpdatePaths<Example, ObjectId>>
>()
...
ta.assert<
  ta.Equal<{ [x in `d.${number}`]: boolean | undefined }, UpdateFlattenTypes<Example, boolean>>
>()
ta.assert<ta.Extends<{}, UpdateFlattenTypes<Example, boolean>>>()
ta.assert<ta.Not<ta.Extends<{ 'd.$': string }, UpdateFlattenTypes<Example, boolean>>>>()
...
ta.assert<
  ta.Extends<{ d?: { $each: boolean[]; $position: 2 } }, UpdateFlattenArrayTypes<Example>>
>()
ta.assert<ta.Extends<{ e?: { f: ObjectId } }, UpdateFlattenArrayTypes<Example>>>()
...
// Test Empty Update
ta.assert<ta.Extends<{}, TsUpdate<Example>>>()

// Testing on non-existing fields
ta.assert<ta.Extends<{}, UpdateFlattenTypes<Example, string>>>()
ta.assert<ta.Not<ta.Extends<{ z: number }, UpdateFlattenTypes<Example, number>>>>()
ta.assert<ta.Not<ta.Extends<{ z: string }, UpdateFlattenTypes<Example, string>>>>()

ta.assert<ta.Not<ta.Extends<{ z: string }, UpdateFlattenTypes<Example, boolean>>>>()
ta.assert<ta.Not<ta.Extends<{ z: string }, UpdateFlattenTypes<Example, ObjectId>>>>()
